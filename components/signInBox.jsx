        ...
        <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
            <div className="rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
                    ...
                    <div className="py-10">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="bg-gray-200 w-64 p-2 flex items-center m-2 rounded-2xl">
                                ...
                                <input type="username" name="username" placeholder="Enter your username" className="border-2 bg-gray-200 
                            ...
                            <div className="bg-gray-200 w-64 p-2 flex items-center m-2 rounded-2xl">
                                ...
                                <input type="password" name="password" placeholder="Enter your password" className="border-2 bg-gray-200 
                                outline-none text-sm flex-1"/>
                            </div>
                            {/* END OF: Password */}
                            ...
                            <a href="#" className="border-2 border-custom-main-dark text-custom-main-dark rounded-full px-12 py-2 inline-block font-semibold
                            hover:bg-custom-main-dark hover:text-white">Sign In</a>
                            <p className="text-gray-400 my-4"> or </p>
                            <div className="flex justify-center">
                            <a href="#" className="border-2 border-gray-400 rounded-full p-4 mx-1 hover:bg-custom-main-dark hover:text-white">
                ...
                <div className= "w-2/5 bg-custom-main-dark text-white rounded-tr-2xl rounded-br-2xl py-36 px-12">
                    ...
                    hover:bg-white hover:text-custom-main-dark">Sign Up</a>
                </div>
